...
INSERT INTO System_UserSetting (Code,Item,Account,Name,PassWord,Rank,DefaultFlag,EnabledFlag)
SELECT '01GQV9KNKM6NS5N1ZCED33GFT4','admin','admin','系统管理员','21232F297A57A5A743894A0E4A801FC3',1,False,True
WHERE NOT EXISTS (SELECT 1 FROM System_UserSetting WHERE Code='01GQV9KNKM6NS5N1ZCED33GFT4');

INSERT INTO System_UserSetting (Code,Item,Account,Name,PassWord,Rank,DefaultFlag,EnabledFlag)
SELECT '01GQV9KNKMJPFR6FQYDBKRQSS1','800020','800020','杨迪','18436C0BD4BF414C19EDA4B968930473',2,False,True
WHERE NOT EXISTS (SELECT 1 FROM System_UserSetting WHERE Code='01GQV9KNKMJPFR6FQYDBKRQSS1');

INSERT INTO System_UserSetting (Code,Item,Account,Name,PassWord,Rank,DefaultFlag,EnabledFlag)
SELECT '01GQV9KNKMXYD7KRXV9ZZR8KXF','800244','8A1414','祝捷','50F3F8C42B998A48057E9D33F4144B8B',3,False,True
WHERE NOT EXISTS (SELECT 1 FROM System_UserSetting WHERE Code='01GQV9KNKMXYD7KRXV9ZZR8KXF');

INSERT INTO System_UserSetting (Code,Item,Account,Name,PassWord,Rank,DefaultFlag,EnabledFlag)
SELECT '01GQV9KNKMF6QWHQWWJY4KPGHA','102500','102500','祝捷','50F3F8C42B998A48057E9D33F4144B8B',5,False,True
